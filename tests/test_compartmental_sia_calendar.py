...
from laser_measles.compartmental import CompartmentalModel, CompartmentalParams, BaseScenario
from laser_measles.compartmental.components import SIACalendarProcess, SIACalendarParams
...
def mock_sia_schedule():
    ...
    return pl.DataFrame({
        "id": ["NG:KN", "NG:KD", "NG:KN"],
        "date": ["2023-01-10", "2023-01-15", "2023-01-25"]
    })
...
class TestSIACalendarParams:
    ...
    def test_custom_params(self, mock_sia_schedule):
        ...
        params = SIACalendarParams(
            sia_schedule=mock_sia_schedule,
            sia_efficacy=0.8,
            aggregation_level=2,
