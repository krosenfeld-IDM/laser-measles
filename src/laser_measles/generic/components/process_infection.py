...
class InfectionProcess:
    ...
    def __call__(self, model, tick) -> None:
        ...
        InfectionProcess.nb_infection_update_test(model.population.count, model.population.itimer, model.population.state, flow, model.population.nodeid)
    ...
    def on_birth(self, model, _tick, istart, iend) -> None:
        ...
        if iend is not None:
            InfectionProcess.nb_set_itimers_slice(istart, iend, model.population.itimer, np.uint16(0))
        else:
            InfectionProcess.nb_set_itimers_randomaccess(istart, model.population.itimer, np.uint16(0))
        return
...
class InfectionSISProcess:
    ...
    def __init__(self, model, verbose: bool = False) -> None:
        ...
        model.population.add_scalar_property("itimer", dtype=np.uint16, default=0)
        InfectionSISProcess.nb_set_itimers(0, model.population.count, model.population.itimer, 0)
    ...
    def __call__(self, model, tick) -> None:
        ...
        InfectionSISProcess.nb_infection_update(model.population.count, model.population.itimer, model.population.susceptibility)
        return
