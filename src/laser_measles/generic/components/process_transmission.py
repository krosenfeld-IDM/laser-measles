...
class TransmissionProcess:
    ...
    def __call__(self, model, tick) -> None:
        ...
        if hasattr(population, "etimer"):
            TransmissionProcess.nb_transmission_update_exposed(
            ...
            TransmissionProcess.nb_transmission_update_noexposed(
                population.susceptibility,
                population.nodeid,
                population.state,
                forces,
            ...
            TransmissionProcess.nb_transmission_update_SI(
                population.susceptibility,
                population.nodeid,
                population.state,
                forces,
...
class TransmissionSIRProcess(TransmissionProcess):
    """
